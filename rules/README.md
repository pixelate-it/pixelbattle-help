...
4. Разрешены только ссылки на ресурсы, указанные в [списке разрешённых доменных имён](allowed-domains.md). Запрещены ссылки на ресурсы, которые содержат NSFW-контент, коммерческий контент, пропагандируют ненависть, дискриминацию, экстремизм или являются потенциально вредоносными.
